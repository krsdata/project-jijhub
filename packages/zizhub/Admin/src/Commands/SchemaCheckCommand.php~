...
use Inventory\Admin\Exceptions\Commands\DatabaseTableReservedException;
use Inventory\Admin\Exceptions\Commands\DependencyNotFoundException;
...
class SchemaCheckCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'zizhub:check-schema';
