...
class CopounsController extends Controller {
    ...
    public function store( ZizhubCouponsRequest $request , Coupon $zizpicCoupons ) {
        ...
        return Redirect::to( $this->ln . '/zizhub/coupons/' . $coupon_id )
                        ->with( 'flash_alert_notice' , 'Zizhub order coupons was successfully created !' )->with( 'alert_class' , 'alert-success alert-dismissable' );
    }
     ...
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function update( ZizhubCouponsRequest $zizpicCouponsRequest , Coupon $zizpicCoupons ) {

        $zizpicCoupons->fill( Input::all() );
        $zizpicCoupons->save();
        return Redirect::to( $this->ln . '/zizhub/coupons' )
                        ->with( 'flash_alert_notice' , 'Zizhub order coupons was successfully updated !' )->with( 'alert_class' , 'alert-success alert-dismissable' );
    }
    ...
    public function show( Coupon $coupon ) {
        $query = (new CouponCode )
                ->newQuery()
                ->join( 'zizhubCoupon' , 'zizhubCoupon.id' , '=' , 'zizhub_copoun_codes.copoun_id' )
                ->select( 'zizhubCoupon.id' , 'zizhubCoupon.package' , 'zizhub_copoun_codes.code' , 'zizhubCoupon.exp_date' , 'amount_usd' , 'amount_nis' )
                ->where( 'zizhubCoupon.id' , $coupon->id );
