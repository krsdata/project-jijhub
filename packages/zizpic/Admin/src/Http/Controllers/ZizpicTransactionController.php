...
class ZizpicTransactionController extends Controller {
        ...
        $grid->setColumns( [
            ...
            ,
                    ...
                    ->setCallback( function ($val , $row ) {
                        ...
                        $html = '<a class="pull-left btn-default btn" href="' . route( 'zizpictransactions.show' , $attr->id ) . '" >Show Details</a>';
    ...
    public function show( ZizpicOrder $zizpicOrder ) {
        ...
        $helper = new Helper;
        $count_record=$helper->zizpic_product_count($zizpicOrder->id); 
        $shiping_address = ZizpicOrder::where( 'id' , $zizpicOrder->id )->get()->toArray();
        return $this->view( 'packages::zizpic.orders' , compact( 'results' , 'page_title' , 'shiping_address','count_record' ) );
    }
